...
class odbc {
  ...
  // returns nothing                                                          //
  // usage: $db = new odbc($host, $dbname, $uname, $pass);                //
  //--------------------------------------------------------------------------//
  ...
  //--------------------------------------------------------------------------//
  // connect ODBC Driver 17 for SQL Server - Easysoft ODBC-SQL Server - SQL Server                                                         //
  //--------------------------------------------------------------------------//
  ...
  function connect() {
    if ($this->db = odbc_connect("DRIVER={SQL Server};SERVER=$this->host;PORT=1433;DATABASE=$this->dbname;", $this->user, $this->password)) return true;
    return false;
  }
