...
$replace_route = 'admvisch/public/themes/neon/assets/js/filemanager/';
...
$url = obtenerURL();
$datos = parse_url($url);
$url_self_explode = explode('/', $_SERVER['PHP_SELF']);
$config['base_url'] = str_replace($replace_route, '', str_replace(end($url_self_explode), '', $config['base_url'] . $datos['path']));
