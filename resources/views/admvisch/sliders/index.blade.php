<x-app-layoutt>
    ...
    <div class="form-group">
        <a href="{{ route('sliders.enter') }}" type="button" class="btn btn-blue"><i class="fa fa-plus"></i> Nuevo</a>
    </div>
    @endcan
    ...
    <div class="table-responsive">
        <table class="table table-bordered datatable order-table" id="table-3">
            ...
            <tbody>
                ...
                if ($slider->location == $keyLocation) {
                ...
                <tr id="<?php echo $slider->id; ?>">
                    ...
                    <td width="6%">
                        ...
                        data-original-title="Editar" href="{{ route('sliders.edit', $slider->id) }}"><i
                            class="fa fa fa-pencil-square-o"></i></a>
                        @endcan
                        
                        @can('sliders.eliminar')
            ...
            jQuery(document).on("click", ".delete-register", function() {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result == true) {
                            jQuery(location).attr('href', 'sliders/delete/' + id);
                        }
                    }
                });
            });
