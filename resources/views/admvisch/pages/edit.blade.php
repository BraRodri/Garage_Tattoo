<x-app-layoutt>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form role="form" id="form1" method="post" action="{{ route('pages.update') }}"
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body color-gris-fondo form-groups-bordered">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control required" name="title" id="title"
                                        maxlength="255"
                                        value="<?php echo $page->title; ?>" />
                                    <label class="form-control"><?php echo $page->title; ?></label>
                                    @error('title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>

                                <?php if ($page->title == 'empresa.php') { ?>
                                <div class="form-group">
                                    <label class="control-label">Introducción</label>
                                    <textarea class="form-control ckeditor" name="introduction"
                                        id="introduction"><?php echo $page->introduction; ?></textarea>
                                </div>
                                <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="description"
                                        id="description"><?php echo $page->description; ?></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 no-padding">
                                        <div id="label-switch" class="make-switch" data-on-label="SI"
                                            data-off-label="NO">
                                            <input type="checkbox" name="active" id="active" value="1" <?php if ($page->active == 1) {
                            ...
                            <div class="panel-body color-gris-fondo form-groups-bordered">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_title" id="meta_title"
                                        maxlength="255"
                                        value="<?php echo $page->meta_title; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="meta_author" id="meta_author"
                                        maxlength="100"
                                        value="<?php echo $page->meta_author; ?>" />
                                    <label class="formNote">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_keyword" id="meta_keyword"
                                        rows="5"><?php echo $page->meta_keyword; ?></textarea>
                                    <label class="formNote">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="meta_robots" id="meta_robots">
                                            ...
                                            <option value="index,follow" <?php echo isset($page->meta_robots) && !empty($page->meta_robots) &&
                                                $page->meta_robots == 'index,follow' ? 'selected="selected"' : '';
                                                ?>>Indexar la página y seguir los enlaces</option>
                                            <option value="index,nofollow" <?php echo isset($page->meta_robots) && !empty($page->meta_robots) &&
                                                $page->meta_robots == 'index,nofollow' ? 'selected="selected"' :
                                                ''; ?>>Indexar la página y no seguir los enlaces
                                            </option>
                                            <option value="noindex,follow" <?php echo isset($page->meta_robots) && !empty($page->meta_robots) &&
                                                $page->meta_robots == 'noindex,follow' ? 'selected="selected"' :
                                                ''; ?>>No indexar la página y seguir los enlaces
                                            </option>
                                            <option value="noindex,nofollow" <?php echo isset($page->meta_robots) && !empty($page->meta_robots) &&
                                                $page->meta_robots == 'noindex,nofollow' ? 'selected="selected"' :
                                                ''; ?>>No indexar la página y no seguir los enlaces
                                            </option>
                                        </select>
                                        <div class="clearfix"></div>
                                        <label class="formNote">
