<x-app-layoutt>
    ...
    <div class="form-group">
        <a href="{{route('pages.enter')}}" type="button"
    ...
    <div class="table-responsive">
        <table class="table table-bordered datatable" id="table-3">
            ...
            <tbody>
                ...
                $class_status = $page->active == 1 ? 'success' : 'default';
                $text_status = $page->active == 1 ? 'Activo' : 'Inactivo';
                ?>
                <tr>
                    <td width="5%">#<?php echo $page->id; ?></td>
                    <td><?php echo $page->title; ?></td>
                    <td width="7%" align="center"><a style="cursor: pointer;" class="change-status"
                            id="<?php echo $page->id; ?>"><span
                                class="badge badge-<?php echo $class_status; ?>"><?php echo $text_status; ?></span></a></td>
                    <td width="10%"><?php echo Application\Helper::dateFormatUser($page->updated_date);
                        ?></td>
                    <td width="10%"><?php echo $page->author; ?></td>
                    <td width="6%">
            ...
            jQuery(document).on("click", ".delete-register", function() {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result == true) {
                            jQuery(location).attr('href','pages/delete/' + id);
                        }
                    }
                });
            });
