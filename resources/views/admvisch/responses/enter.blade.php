...
@endif
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{route('responses.insert')}}" enctype="multipart/form-data" class="custom-validate form-groups-bordered">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control ckeditor required" name="description1" id="description1"></textarea>
                        </div>
                    </div>
                    <?php /*?>
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-condensed table-bordered">
                                    ...
                                    <tr>
                                        <td>Nombre de Sociedad: <span class="label label-danger">{SOCIETY_NAME}</span></td>
                                    </tr>
                                    <tr>
                                        <td>Dirección de Sociedad: <span class="label label-danger">{SOCIETY_ADDRESS}</span></td>
                                    </tr>
                                    <tr>
                                        <td>Cta Cte de Sociedad: <span class="label label-danger">{SOCIETY_CTA_CTE}</span></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control ckeditor required" name="description2" id="description2"></textarea>
                        </div>
                    </div>
                    <?php /*?>
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control ckeditor required" name="description3" id="description3"></textarea>
                        </div>
                    </div>
                    <?php /*?>
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control ckeditor required" name="description4" id="description4"></textarea>
                        </div>
                    </div>
                    <?php /*?>
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <a href="{{route('responses')}}" type="button" class="btn btn-primary"><i class="fa fa-angle-double-left"></i> Cancelar y Volver</a>
                </div>
