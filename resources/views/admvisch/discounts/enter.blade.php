<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{ route('discounts.insert') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control required" name="code" id="code" maxlength="255" />
                    <label class="formNote">* Ingresar en mayúsculas, sin espacios, sin acentos y sin caracteres
                        especiales. Ejemplo: CUPON2020</label>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label">Descuento $</label>
                    <input type="text" class="form-control digits" name="discount" id="discount" value="" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control required" name="restrictions" id="restrictions" rows="5"></textarea>
                    <label class="formNote">* Indicar texto para explicar el uso y restricciones que aplica el cupón de
                        descuento.</label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 no-padding">
                        <div id="label-switch" class="make-switch" data-on-label="SI" data-off-label="NO">
                            <input type="checkbox" name="send" id="send" value="1" checked="checked">
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <label class="formNote">* Esta opción le permite enviar masivamente el cupón a todos sus clientes o
                        bien a los seleccionados mediante el tipo "clientes".</label>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('discounts') }}" type="button" class="btn btn-primary"><i
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                $('select[name=type]').change(function() {
                    ...
                    if (type == '') {
                    ...
                    } else if (type == 'Clients' || type == 'Categories' || type == 'Brands' || type ==
                        'Products') {
                        ...
                        var url = url('/discounts/get/'.type);
                        var data = {}
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('select.dual-list-box').append(response
                                    .relations_selected);

                                var dual_list_box2 = $('.dual-list-box')
                                ...
                                function initDualListBox() {
                                    var instance = dual_list_box2.data(
                                        'plugin_bootstrapDualListbox');
                                    var nonSelectedList = instance.elements.select2;
                                    var isDualListBoxValidated = !(instance
                                        .selectedElements > 0);

                                    nonSelectedList.prop('required',
                                        isDualListBoxValidated);
                                    instance.elements.originalSelect.prop('required',
                                        false);

                                    if (isDualListBoxValidated == false) {
                                        $('select.dual-list-box-1').parent().removeClass(
                                            'validate-has-error');
                                    }
                                }
