    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post"
                action="{{route('publicities.insert')}}"
                ...
                */ @endphp
                ...
                <div class="form-group">
                    ...
                    <label class="formNote">
                        * Se recomienda subir imagen para DESKTOP de 1920 x 60 px. En formato JPG o PNG.
                    </label> <br>
                    <label class="formNote">
                        * Se recomienda subir imagen para MOVIL de 580 x 100 px. En formato JPG o PNG.
                    </label>
                    <div class="clearfix"></div>
