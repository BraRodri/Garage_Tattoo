    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post"
                action="{{route('publicities.update')}}"
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select class="form-control" name="location" id="location">
                            ...
                            <?php $selection = $publicity->location == $keyLocation ?
                            "selected='selected'" : ''; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control required" name="title" id="title" maxlength="255"
                        value="<?php echo $publicity->title; ?>" />
                ...
                <div class="form-group">
                    ...
                    <label class="formNote">
                        * Se recomienda subir imagen de <?php echo $image_description; ?> px. En formato JPG.
                    </label>
                    <div class="clearfix"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="clearfix"></div>
                    <a href="{{ asset($publicity->image) }}" data-fancybox="galeria"><img
                        src="{{ asset($publicity->image) }}" width="170" height="101" /></a>
                </div>
                @endif
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select class="form-control" name="target" id="target">
                            <option value="">Seleccionar</option>
                            <option value="_blank" <?php echo $publicity->target == '_blank' ?
                                "selected='selected'" : ''; ?>>Nueva Pestaña</option>
                            <option value="_self" <?php echo $publicity->target == '_self' ?
