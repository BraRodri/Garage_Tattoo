                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select class="form-control required" name="region_code" id="region_code">
                            ...
                            <option value="<?php echo $region['code']; ?>"><?php echo $region['code_internal'] . ' - Región de ' .
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12 no-padding">
                        <div id="label-switch" class="make-switch" data-on-label="SI" data-off-label="NO">
                            <input type="checkbox" name="active_shipping" id="active_shipping" value="1">
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
    ...
    <x-slot name="js">
        ...
        <script type="text/javascript">
            ...
            jQuery('select[name=region_code]').change(function() {
                ...
                jQuery('select[name=parent_code]').load('provinces/' + code);
            });
