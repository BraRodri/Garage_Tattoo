<x-app-layoutt>
    ...
    @can('slidersClients.agregar')
    <div class="form-group">
        <a href="{{ route('slidersClients.enter') }}" type="button" class="btn btn-blue"><i class="fa fa-plus"></i>
            Nuevo</a>
    </div>
    @endcan 
    ...
    <x-slot name="js">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                $(".order-table tbody").sortable({
                    ...
                    update: function(event, ui) {
                        ...
                        url = "{{route('slidersClients.orders')}}";
            ...
            jQuery(document).on("click", ".delete-register", function() {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result == true) {
                            jQuery(location).attr('href', 'slidersClients/delete/' + id);
                        }
                    }
                });
            });
            ...
            jQuery(document).on("click", ".change-status", function() {
                ...
                var url = "{{route('slidersClients.status')}}";
                var data = {
