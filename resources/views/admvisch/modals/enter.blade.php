<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{ route('modals.insert') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control timepicker required" name="start_hour" id="start_hour"
                        value="" data-template="dropdown" data-show-seconds="false" data-default-time="12:00 AM"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control timepicker required" name="end_hour" id="end_hour" value=""
                        data-template="dropdown" data-show-seconds="false" data-default-time="11:59 PM"
                        data-show-meridian="true" data-minute-step="5" />
                    @error('end_hour')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
