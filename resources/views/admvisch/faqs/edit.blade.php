<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{ route('faqs.update') }}"
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control ckeditor required" name="description1" id="description1">
