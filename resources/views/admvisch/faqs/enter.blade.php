<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{route('faqs.insert')}}" enctype="multipart/form-data" class="custom-validate form-groups-bordered">
                ...
                <div class="form-group">
                    ...
                    <a href="{{route('faqs')}}" type="button" class="btn btn-primary"><i class="fa fa-angle-double-left"></i> Cancelar y Volver</a>
                </div>
