<x-app-layoutt>
    ...
    <ol class="breadcrumb bc-2">
        ...
        <li>
            <a href="{{ route('users') }}"><?php echo $title; ?></a>
        </li>
        <li class="active">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{ route('users.insert') }}"
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select class="form-control required" name="roles_id" id="roles_id">
                            ...
                            <option value="<?php echo $rol['name']; ?>"><?php echo $rol['name']; ?></option>
                            <?php }
                            } ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control required rut" name="rut" id="rut" placeholder="11.111.111-1"
                        maxlength="12" />
                </div>

                <div class="form-group">
                    <label class="control-label">Nombre</label>
                    <input type="text" class="form-control required" name="name" id="name" maxlength="255" />
                </div>

                <div class="form-group">
                    <label class="control-label">Email</label>
                    <input type="text" class="form-control required email" name="email" id="email" maxlength="100" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('users') }}" type="button" class="btn btn-primary"><i
