<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{route('blog.insert')}}" enctype="multipart/form-data" class="custom-validate form-groups-bordered">
                ...
                <div class="form-group">
                    ...
                    <label class="formNote">* Se recomienda subir imagen de <?php echo
                        $image_description; ?> px. En formato JPG o PNG.</label>
                    <div class="clearfix"></div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control required" name="description1" id="ckeditor_blog"></textarea>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <a href="{{route('admin.blog')}}" type="button" class="btn btn-primary"><i class="fa fa-angle-double-left"></i> Cancelar y Volver</a>
                </div>
