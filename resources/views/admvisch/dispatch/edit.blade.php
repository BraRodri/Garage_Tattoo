<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{ route('config.dispatch.update') }}"
            enctype="multipart/form-data" class="custom-validate form-groups-bordered">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <textarea class="form-control required" name="description1" id="description1">{{$configDispatch->description}}</textarea>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control required" name="price" id="price" value="{{$configDispatch->price}}" />
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="id"
                        value="<?php echo $configDispatch->id; ?>" />
                </div>
