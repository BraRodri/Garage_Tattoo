...
@endsection
    <ol class="breadcrumb bc-2">
        ...
        <li>
            <a href="{{route('products.importGalleries')}}"><?php echo $title; ?></a>
        </li>
        <li class="active">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post"
                action="{{route('products.uploadGalleries')}}"
                ...
                <div class="form-group">
                    ...
                    <ul>
                        ...
                        <li class="text-danger-red">Para importar correctamente el archivo, descarga el formato <a
                                href="{{route('products.exportGalleries')}}">aquí</a>.
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li class="text-danger-red">Recuerde que el nombre de la &quot;<strong>Imagen&quot;</strong>
                    ...
                    <ul>
                        <li class="text-danger-red">Antes de importar el excel, cargue las imágenes en: "<strong><?php echo UPLOAD_URL_ROOT . 'productsGalleries' . DS . 'img'; ?></strong>". Este procedimiento ayudará a comprobar si coincide el nombre especificado
                            con el archivo.</li>
                    </ul>
                ...
                <div class="form-group">
                    <button type="button" class="btn btn-orange" id="import-file"><i class="fa fa-exchange"></i>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                $('#modalMessageImport').on('hide.bs.modal', function() {
                    $(location).attr('href',  "{{route('products.importGalleries')}}");
                });

                $('#import-file').click(function() {

                    var url = "{{route('products.uploadGalleries')}}";
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.error == 0) {
                                $('body').loadGalleriesByExcel(response.archiveName);
                            } else {
                                bootbox.alert({
                ...
                $.fn.loadGalleriesByExcel = function(archiveName) {

                    var url = "{{route('products.loadGalleriesByExcel')}}";
                    var data = {
                ...
                function progress_bar_process(percentage, timer, type_send, idIntervalGlobal) {
                    ...
                    //console.log(percentage + ' - ' + timer + ' - ' + idIntervalGlobal);
