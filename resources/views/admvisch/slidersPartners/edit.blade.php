<x-app-layoutt>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body color-gris-fondo">
            ...
            <form role="form" id="form1" method="post" action="{{ route('slidersPartners.update') }}"
                ...
                @if (!empty($slider->image))
                    <div class="form-group">
                        ...
                        <div class="clearfix"></div>
                        <a href="{{ asset($slider->image) }}" data-fancybox="galeria"><img
                                src="{{ asset($slider->image) }}" width="170" height="101" /></a>
                    </div>
                @endif
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('slidersPartners') }}" type="button" class="btn btn-primary"><i
