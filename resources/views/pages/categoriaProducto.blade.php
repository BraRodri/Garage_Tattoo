                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                <div class="sv-producto-mod">
                                    ...
                                    <div class="sv-producto-agregar sv-p-centrar">
                                        ...
                                        @if($value->product->attribute_active == 0)
                                            ...
                                            @if ($value->product->stock > 0)
                                                ...
                                                @if ($agregado)
                                                    ...
                                                    <form action="{{ route('cart_details.store') }}" method="post" class="">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="number" class="form-control" name="quantity" id="quantity" min="1" max="{{$value->product->stock}}" value="1" style="width: 60px">
                                                            </div>
                                                            <div class="col">
                                            ...
                                            @else
                                            <a href="{{ route('detalle.producto', $value->product->slug) }}" class="btn btn-dark">AGREGAR AL CARRO</a>
